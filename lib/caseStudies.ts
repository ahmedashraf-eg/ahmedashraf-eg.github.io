...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    card: {
      title: "Bright Bite — a dental practice platform, live in three weeks",
      desc: "A clinic's whole operation in one system: reception and clinical records, tooth charting, billing, a bilingual booking site and patient self check-in — with every permission generated from a single typed matrix and enforced by the database, not the interface.",
      tags: ["Postgres · RLS · Supabase", "React · Astro · Deno", "n8n · WhatsApp · LLM routing"],
    },
    cover: {
      kicker: "Case 04 — Platform · Healthcare",
      title: "A dental practice rebuilt end to end — where a missing warning is a clinical statement",
      sub: "Bright Bite, Cairo · live and running the practice · patients book and check themselves in online · 48 migrations, 90 RLS policies, 51 database functions, 11 edge functions, a 19-step CI gate · built in three weeks.",
    },
    meta: {
      client: "Bright Bite · dental clinic, Cairo",
      role: "Sole engineer — platform, automation, marketing site",
      timeline: "2026 · ~3 weeks to live",
      focus: "Clinical safety, data integrity, bilingual UX",
    },
    sections: [
      {
        num: "01",
...
export const site = {
  name: "Ahmed Ashraf",
  tagline: "Software, thoughtfully made.",
